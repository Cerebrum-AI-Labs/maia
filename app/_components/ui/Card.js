...
export function Card({ title, description, children }) {
  return (
    <>
      <CardX children={children} description={description} title={title} />
    </>
  );
}
...
const CardX = ({ title, description, children }) => {
  ...
  return (
    <div
      ...
      className="bg-background border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative h-[30rem]"
    >
